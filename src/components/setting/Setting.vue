    ...
    <setting-item>
      <a-list :split="false">
        <a-list-item>
          ...
          >
            <a-select-option value="content-fluid">{{$t('navigate.content.fluid')}}</a-select-option>
            <a-select-option value="content-fixed">{{$t('navigate.content.fixed')}}</a-select-option>
          </a-select>
        </a-list-item>
        <a-list-item>
