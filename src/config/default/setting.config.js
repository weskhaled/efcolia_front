...
module.exports = {
    lang: 'US', //语言，可选 CN(简体)、HK(繁体)、US(英语)，也可扩展其它语言
    theme: { //主题
        color: '#1890ff', //主题色
    ...
    pageWidth: 'content-fluid', //内容区域宽度，fixed:固定宽度，fluid:流式宽度
    fixedTabs: false, //固定页签头，true:固定，false:不固定
    weekMode: false, //色弱模式，true:开启，false:不开启
    multiPage: false, //多页签模式，true:开启，false:不开启
    hideSetting: false, //隐藏设置抽屉，true:隐藏，false:不隐藏
    systemName: 'Efcolia', //系统名称
    copyright: '2021 MATIASAT SYSTEM GROUP', //copyright
